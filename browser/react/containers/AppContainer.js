...
import PlayerCreator from '../action-creators/player';
...
export default class AppContainer extends Component {
  ...
  constructor (props) {
    ...
    this.addSongToPlaylist = this.addSongToPlaylist.bind(this);
     this.storeState = Object.assign({}, Store.getState());
  }
  ...
  play () {
    AUDIO.play();
    Store.dispatch(PlayerCreator("play"));
  }

  pause () {
    AUDIO.pause();
    Store.dispatch(PlayerCreator("pause"));
  }
  ...
  toggle () {
    ...
    if (this.storeState.player.isPlaying) this.pause();
    else this.play();
  }
    ...
    return (
      <div id="main" className="container-fluid">
        ...
        <Player
          ...
          isPlaying={this.storeState.player.isPlaying}
